        ...
        >
          <div>
            <div className="mb-6 flex items-center gap-3 text-xs font-black uppercase tracking-[0.24em] text-purple-700">
              <span className="h-px w-10 bg-purple-400" /> About me
            </div>
            <h2 className="max-w-xl text-4xl font-black leading-[1.05] tracking-[-0.045em] text-gray-950 sm:text-5xl lg:text-6xl">
              I connect code with
              <span className="bg-gradient-to-r from-purple-600 via-fuchsia-500 to-blue-600 bg-clip-text text-transparent"> real business impact.</span>
            </h2>

            <div className="mt-9 flex items-center gap-4">
              <span className="text-2xl font-black tracking-[-0.04em] text-gray-950">END TO END</span>
              <span className="max-w-32 text-sm font-semibold leading-snug text-gray-500">
                thinking across the entire product
              </span>
            </div>
          </div>
          ...
          <div className="lg:pt-10">
            <div className="space-y-5 text-lg leading-relaxed text-gray-600">
              <p>
                I work across the full stack—from polished interfaces and backend systems to cloud
                infrastructure, integrations and technical SEO.
              </p>
              <p>
                That end-to-end perspective helps me make better decisions: architecture supports
                performance, performance improves discovery, and every technical choice serves the
